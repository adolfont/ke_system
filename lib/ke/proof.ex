defmodule KE.Proof do
  ...
  def apply_rule(proof = %__MODULE__{}, _rule) do
  ...
  def apply_rule(proof = %__MODULE__{}, _rule, _premise) do
  ...
  def apply_rule(proof = %__MODULE__{}, _rule, _premise1, _premise2) do
  ...
  def example_for_tests() do
    f = {:T, {:not, :p}}
    p = new([f])

    apply_rule(p, &KE.Rules.t_not/1, f)
    |> IO.inspect()
  end
end

KE.Proof.example_for_tests()
